...
const data: { products: ProductItem[] } = {
  products: [
    ...
    },
    {
      id: 5,
      title: 'Huawei P30',
      description: 'Huawei’s re-badged P30 Pro',
    ...
    },
    {
      ...
      description: "L'OrÃ©al Paris introduces Hyaluron Expert Replumping Serum",
      thumbnail: 'https://i.dummyjson.com/data/products/16/thumbnail.jpg',
    },
    {
      id: 17,
      title: 'Tree Oil 30ml',
      description: 'Tea tree oil contains',
